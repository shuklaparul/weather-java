...
public class TestWeatherService {
	 ...
	 * @throws JSONException
	 **/
	public void getValidStationIdwithTimeframe() throws ParseException {
		try {
			...
			Assert.fail("Invalid input provided");
		}
	 ...
	 * @throws JSONException
	 **/
	public void createObservation() throws  ParseException {
		try {
